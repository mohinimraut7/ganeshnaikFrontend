    ...
    <>
      <style>{`
        ...
        .footer-logo-circle {
          ...
          display: flex; align-items: center; justify-content: center;
          font-size: 22px; flex-shrink: 0;
          box-shadow: 0 4px 16px rgba(247,128,26,0.4);
        }
        .footer-brand-name {
          font-family: 'Tiro Devanagari Marathi', serif;
          font-size: 15px; font-weight: 700;
        ...
        .footer-address { margin-bottom: 24px; }
        .footer-address-title {
          font-size: 11px; font-weight: 700; color: #FFD0A0;
          text-transform: uppercase; letter-spacing: 0.8px;
          margin-bottom: 10px;
        }
        .footer-address-text {
        ...
        .footer-contact-icon { color: #FFD0A0; font-size: 14px; flex-shrink: 0; margin-top: 1px; }
        .footer-contact-label { color: rgba(255,255,255,0.45); font-size: 11px; }

        /* ── Col 2 & 3 ── */
        .footer-col-title {
          font-size: 13px; font-weight: 700; color: #FFE0B2;
          letter-spacing: 0.5px; margin-bottom: 20px;
          padding-bottom: 10px;
        ...
        .footer-links li a:hover,
        .footer-links li button:hover { color: #FFE0B2; padding-left: 4px; }
        .footer-links li a::before,
        .footer-links li button::before { content: '›'; color: #FFD0A0; font-size: 15px; }

        /* ── Social ── */
        .footer-social { display: flex; gap: 10px; margin-bottom: 24px; }
        .footer-social-btn {
          width: 36px; height: 36px; border-radius: 50%;
          border: 1px solid rgba(255,208,160,0.35);
          background: rgba(255,208,160,0.08);
          display: flex; align-items: center; justify-content: center;
          color: rgba(255,255,255,0.65); font-size: 15px;
          cursor: pointer; transition: all .18s; text-decoration: none;
        }
        .footer-social-btn:hover { background: #F7801A; color: #fff; border-color: #F7801A; }
        ...
        .footer-map-wrap {
          border-radius: 14px; overflow: hidden;
          border: 1px solid rgba(255,208,160,0.25);
        ...
        .footer-map-label {
          position: absolute; bottom: 0; left: 0; right: 0;
          background: linear-gradient(0deg, rgba(132,58,0,0.95) 0%, transparent 100%);
          padding: 14px 14px 10px;
          font-family: 'Tiro Devanagari Marathi', serif;
          font-size: 12px; color: var(--gold); font-weight: 600;
          text-align: center;
        ...
        .footer-divider {
          position: relative; z-index: 1;
          max-width: 1200px; margin: 0 auto;
          height: 1px; background: rgba(255,224,178,0.18);
          margin-left: 48px; margin-right: 48px;
        }
        ...
        .footer-back-top {
          ...
          background: transparent;
          border-radius: 999px; padding: 8px 20px;
          font-size: 12px; font-weight: 700; color: #FFD0A0;
          cursor: pointer; transition: all .2s; letter-spacing: 0.5px;
          text-transform: uppercase;
        }
        .footer-back-top:hover { background: rgba(247,128,26,0.2); transform: translateY(-2px); }
        .footer-back-top svg { transition: transform .2s; }
        .footer-back-top:hover svg { transform: translateY(-3px); }
